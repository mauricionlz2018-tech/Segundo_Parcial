            ...
            <div className="bg-white dark:bg-[#1E293B] rounded-2xl shadow-lg dark:shadow-xl px-7 py-8 border border-gray-200 dark:border-gray-700">
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-1">
                  <label htmlFor="fullName" className="text-[10px] font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-wider">Nombre Completo</label>
                  <input
                    id="fullName"
                    type="text"
                    required
                ...
                {/* Correo */}
                <div className="flex flex-col gap-1">
                  <label htmlFor="email" className="text-[10px] font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-wider">Correo Institucional o Matrícula</label>
                  <input
                    id="email"
                    type="email"
                    required
                ...
                {/* Carrera */}
                <div className="flex flex-col gap-1">
                  <label htmlFor="carrera" className="text-[10px] font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-wider">Carrera</label>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="flex flex-col gap-1">
                    <label htmlFor="password" className="text-[10px] font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-wider">Contraseña</label>
                    <div className="relative">
                      <input
                        id="password"
                      ...
                      />
                      <button type="button" onClick={() => setShowPassword(!showPassword)} className={`absolute right-2 top-1/2 -translate-y-1/2 transition-all ${showPassword ? "text-gray-600 dark:text-gray-400" : "text-gray-400 dark:text-gray-600"}`} aria-label="toggle password">
                        <Eye size={14} />
                      </button>
                    </div>
                  </div>
                  <div className="flex flex-col gap-1">
                    <label htmlFor="confirm" className="text-[10px] font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-wider">Confirmar</label>
                    <div className="relative">
                      <input
                        id="confirm"
                        ...
                        className="w-full border border-gray-200 dark:border-gray-600 rounded-lg px-3 py-2.5 pr-8 text-sm text-[#1A1B22] dark:text-white outline-none focus:border-[#64FC05] dark:focus:border-[#10B981] focus:ring-1 focus:ring-[#64FC05] dark:focus:ring-[#10B981] transition bg-gray-50/40 dark:bg-[#0F172A] [&::-ms-reveal]:hidden"
                      />
                      <button type="button" onClick={() => setShowConfirm(!showConfirm)} className={`absolute right-2 top-1/2 -translate-y-1/2 transition-all ${showConfirm ? "text-gray-600 dark:text-gray-400" : "text-gray-400 dark:text-gray-600"}`} aria-label="toggle confirmation">
                        <Eye size={14} />
                      </button>
                    </div>
                  </div>
