      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row md:items-start gap-8">
          ...
          <div className="flex gap-4 md:shrink-0">
            {/* Card 1 – white */}
            <div className="bg-white dark:bg-[#1E293B] rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm dark:shadow-lg px-8 py-6 flex flex-col items-center min-w-[110px] hover-lift animate-fade-in-up delay-100">
            ...
            {/* Card 2 – green */}
            <div className="rounded-lg px-8 py-6 flex flex-col items-center min-w-[110px] bg-[#64FC05] dark:bg-[#10B981] hover-lift animate-fade-in-up delay-200 animate-pulse-glow">
